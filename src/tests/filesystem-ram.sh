...
##################################################
### both compress and temp directory are full
...
echo -e "COMPRESS_TMP_DIR_PATH=/mnt/limited_dir_1M/ COMPRESS_DIR_PATH=/mnt/limited_dir_5M/ $SCRIPT_DIR/../main.sh"
COMPRESS_TMP_DIR_PATH=/mnt/limited_dir_1M/ COMPRESS_DIR_PATH=/mnt/limited_dir_5M/ $SCRIPT_DIR/../main.sh
...
echo -e "\e[32mRAM test: Success!\e[0m"
